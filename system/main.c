...
process	main(void)
{
	...
	//Lab5 2020200671
	u2020200671_syscall_resume(u2020200671_syscall_create(shell, 8192, 50, "shell", 1, KBD));
	...
	while (TRUE) {
		...
		//Lab5 2020200671
		u2020200671_syscall_resume(u2020200671_syscall_create(shell, 4096, 20, "shell", 1, KBD));
